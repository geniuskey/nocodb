export enum MetaTable {
  ...
  GANTT_DEPENDENCIES = 'nc_gantt_dependencies_v2',
  BASE_TRASH = 'nc_base_trash_v2',
  RECORD_TRASH = 'nc_record_trash_v2',
  VIEW_TRASH = 'nc_view_trash_v2',
  ...
  SNAPSHOT_LOCK = 'nc_snapshot_locks',
