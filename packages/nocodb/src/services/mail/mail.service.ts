    ...
    try {
      switch (mailEvent) {
        ...
        case MailEvent.ORGANIZATION_INVITE: {
          ...
          await mailerAdapter.mailSend({
            to: user.email,
            subject: 'You have been invited to join RowWeave',
        ...
        case MailEvent.ORGANIZATION_ROLE_UPDATE: {
          ...
          await mailerAdapter.mailSend({
            to: user.email,
            subject: 'Role updated in RowWeave',
        ...
        case MailEvent.FORM_SUBMISSION: {
          ...
          await mailerAdapter.mailSend({
            to: emails.join(','),
            subject: `RowWeave Forms: Someone has responded to ${formView.title}`,
